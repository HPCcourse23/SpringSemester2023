...
int main(int argc, char *argv[])
{
    ...
    // Allocate streams, and slabs on the GPU
    constexpr int n_streams = 3;
    stream_info info[n_streams];
    auto plan_2d = make_plan(nGrid, n_streams, info);
    ...
    for (int i = grid_start; i <= grid_end - order; i++)
    {
        ...
        compute_fft_2D_R2C(slab, &info[i % n_streams], plan_2d);
    }
